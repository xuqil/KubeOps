...
INSERT INTO `assets_serverassets_tags` VALUES (2,1,1),(1,1,4),(3,2,1),(4,2,3);
...
INSERT INTO `django_celery_beat_clockedschedule` VALUES (1,'2020-04-30 16:00:00.000000',1),(2,'2020-04-20 16:00:00.000000',1),(3,'2020-05-22 02:00:00.000000',1);
...
INSERT INTO `django_celery_beat_periodictasks` VALUES (1,'2020-05-01 16:44:15.576661');
...
INSERT INTO `django_content_type` VALUES (1,'admin','logentry'),(16,'assets','idc'),(18,'assets','serverassets'),(17,'assets','tags'),(3,'auth','group'),(2,'auth','permission'),(4,'contenttypes','contenttype'),(11,'django_celery_beat','clockedschedule'),(6,'django_celery_beat','crontabschedule'),(7,'django_celery_beat','intervalschedule'),(8,'django_celery_beat','periodictask'),(9,'django_celery_beat','periodictasks'),(10,'django_celery_beat','solarschedule'),(12,'rbac','menu'),(13,'rbac','permission'),(14,'rbac','role'),(15,'rbac','userprofile'),(5,'sessions','session'),(23,'settings','backgroundsettings'),(19,'wiki','category'),(24,'wiki','comment'),(21,'wiki','post'),(20,'wiki','tag');
...
INSERT INTO `django_session` VALUES ('ufmu5bdlnub8rwof64ueb9irjf0ni7ow','','2020-05-19 08:08:18.006928');
...
INSERT INTO `wiki_category` VALUES (2,'用户管理'),(1,'蜂巢');
...
CREATE TABLE `wiki_comment` (
  ...
  KEY `wiki_comment_pid_id_208b86aa_fk_wiki_comment_id` (`pid_id`),
  CONSTRAINT `wiki_comment_pid_id_208b86aa_fk_wiki_comment_id` FOREIGN KEY (`pid_id`) REFERENCES `wiki_comment` (`id`),
...
INSERT INTO `wiki_comment` VALUES (1,'真的平时超喜欢拍回家路上的天空，太漂亮了，虽然我拍的不及实物的万分之','2020-05-05 08:48:24.892957',NULL,1,1),(2,'这张！超喜欢！是本来设闹钟要看流星雨结果睡过头，一觉起来发现真的好好看，从房间的窗口拍的，真的好好看。','2020-05-05 08:48:46.714024',1,1,1),(3,'你好,hello','2020-05-05 10:37:49.466147',NULL,1,2),(4,'哈哈哈','2020-05-05 10:37:56.984460',NULL,1,3),(5,'笑啥','2020-05-05 10:38:08.395396',4,1,2),(6,'没错','2020-05-05 11:34:55.574325',5,1,1),(7,'postman','2020-05-05 12:44:21.211046',NULL,1,1),(8,'@admin: fffff','2020-05-05 12:49:26.271227',7,1,1),(9,'@001: 如果 JavaScript 尝试操作一种“错误”的数据类型，它会试图将该值转换为“正确”的类型。','2020-05-05 12:50:08.018298',3,1,1),(10,'@admin: JavaScript 自动调用变量的 toString() 函数，当您试图“输出”对象或变量时','2020-05-05 12:50:36.306762',9,1,1),(11,'JavaScript 自动调用变量的 toString() 函数，当您试图“输出”对象或变量时','2020-05-05 12:51:14.873771',NULL,2,1);
...
INSERT INTO `wiki_post` VALUES (1,'Card 组件','<h1><span style=\"color: rgb(94, 109, 130);\">Card 组件包括</span><code style=\"color: rgb(94, 109, 130); background-color: rgb(230, 239, 251);\">header</code><span style=\"color: rgb(94, 109, 130);\">和</span><code style=\"color: rgb(94, 109, 130); background-color: rgb(230, 239, 251);\">body</code><span style=\"color: rgb(94, 109, 130);\">部分，</span><code style=\"color: rgb(94, 109, 130); background-color: rgb(230, 239, 251);\">header</code><span style=\"color: rgb(94, 109, 130);\">部分需要有显式具名 slot 分发，同时也是可选的。</span></h1><pre class=\"ql-syntax\" spellcheck=\"false\">&lt;el-card class=\"box-card\"&gt;\r\n  &lt;div slot=\"header\" class=\"clearfix\"&gt;\r\n    &lt;span&gt;卡片名称&lt;/span&gt;\r\n    &lt;el-button style=\"float: right; padding: 3px 0\" type=\"text\"&gt;操作按钮&lt;/el-button&gt;\r\n  &lt;/div&gt;\r\n  &lt;div v-for=\"o in 4\" :key=\"o\" class=\"text item\"&gt;\r\n    {{\'列表内容 \' + o }}\r\n  &lt;/div&gt;\r\n&lt;/el-card&gt;\r\n\r\n&lt;style&gt;\r\n  .text {\r\n    font-size: 14px;\r\n  }\r\n\r\n  .item {\r\n    margin-bottom: 18px;\r\n  }\r\n\r\n  .clearfix:before,\r\n  .clearfix:after {\r\n    display: table;\r\n    content: \"\";\r\n  }\r\n  .clearfix:after {\r\n    clear: both\r\n  }\r\n\r\n  .box-card {\r\n    width: 480px;\r\n  }\r\n&lt;/style&gt;\r\n</pre>','2020-05-05 08:33:24.636920','2020-05-05 09:27:06.599792','Card 组件',0,1,2),(2,'文章评论','<h1>支持三级评论</h1><ol><li>一级</li><li>二级</li><li>三级</li></ol>','2020-05-05 11:39:25.219962','2020-05-05 11:39:25.219999','评论支持',0,1,2);
...
INSERT INTO `wiki_post_tags` VALUES (1,1,1),(2,1,2);
...
INSERT INTO `wiki_tag` VALUES (2,'efacestore'),(1,'jenkinsfile');
...
-- Dump completed on 2020-05-05 21:14:58
